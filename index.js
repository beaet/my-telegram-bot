باشه، متوجه شدم؛
پس این موارد رو می‌خوای:

هر کاربر اول ۵ شانس رایگان داره (بدون ریست روزانه)

به ازای هر دعوت ۵ شانس اضافه دائمی می‌گیره

دکمه جدیدی برای «خرید شانس» اضافه می‌کنیم که با کلیک پیام میده: "برای خرید شانس به این آیدی پیام بدید: @Beast3694"

دکمه‌ها شبیه کیبورد معمولی باشن (شیشه‌ای نباشن)

پنل مدیریت برای آیدی 381183017 با امکانات بن، آن‌بن، تغییر متن استارت، اضافه کردن شانس و ارسال پیام به کاربر خاص


می‌رم سراغ نوشتن کد کامل از اول، با این شرایط.


---

کد کامل ربات با Node.js و telegraf + sqlite3
